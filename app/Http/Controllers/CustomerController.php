...
{
    public function storeCustomer(CreateAdminRequest $request)
    {
        $data               = $request->all();
    ...
    public function searchCustomer(Request $request)
    {
        ...
        // dd($gia_tri);
        $data       = Customer::where('ho', 'like', $gia_tri)
                               ->orWhere('dem', 'like', $gia_tri)
    ...
    public function indexCustomer()
    {
        ...
        return view('admin.index_customer', compact('admin'));
    }
