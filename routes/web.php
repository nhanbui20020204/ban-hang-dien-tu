...
Route::get('/share/chuyen-muc/data', [AdminController::class, 'dataAdmin'])->name('dataChuyenMucAdmin');
...
Route::get('/user/demo', [ChuyenMucController::class, 'demo']);

Route::group(['middleware' => 'user'], function() {
    // Route::group(['middleware' => 'admin', 'prefix' => '/admin'], function()
    Route::group(['prefix' => '/danh-gia'], function() {
        Route::post('/create', [DanhGiaController::class, 'store'])->name('createDanhGia');
        Route::post('/data', [DanhGiaController::class, 'getData'])->name('dataDanhGia');
    });
    //Profile
...
Route::group(['middleware' => 'admin', 'prefix' => '/admin'], function() {
    ...
    //     Route::get('/', [CustomerController::class, 'indexCustomer'])->name('viewCustomer');
    //     Route::get('/data', [CustomerController::class, 'dataCustomer'])->name('dataCustomer');
    //     Route::post('/status', [CustomerController::class, 'statusCustomer'])->name('statusCustomer');
    //     Route::post('/create', [CustomerController::class, 'storeCustomer'])->name('createCustomer');
    //     Route::post('/delete', [CustomerController::class, 'destroyCustomer'])->name('deleteCustomer');
    //     Route::post('/edit', [CustomerController::class, 'edit'])->name('editCustomer');
    //     Route::post('/update', [CustomerController::class, 'update'])->name('updateCustomer');
    //     Route::post('/check-mail', [CustomerController::class, 'checkMail'])->name('checkMailCustomer');
    //     Route::post('/check-mail-update', [CustomerController::class, 'checkMailUpdate'])->name('checkMailUpdateCustomer');

    //     Route::get('/logout', [CustomerController::class, 'logOutCustomer'])->name('CustomerLogOut');
    ...
    Route::group(['prefix' => '/danh-gia'], function() {
    Route::get('/', [DanhGiaController::class, 'index'])->name('viewDanhGiaAdmin');
    // Route::post('/danh-gia', [DanhGiaController::class, 'store'])->name('createDanhGiaAdmin');
    Route::get('/data', [DanhGiaController::class, 'getDataAdmin'])->name('dataDanhGiaAdmin');
    Route::post('/delete', [DanhGiaController::class, 'destroyAdmin'])->name('deleteAdmin');
    Route::post('/status', [DanhGiaController::class, 'status'])->name('statusDanhGiaAdmin');
...
Route::group(['middleware' => 'partner', 'prefix' => '/partner'], function() {
    ...
    Route::group(['prefix' => '/don-hang'], function() {
        Route::get('/', [PartnerController::class, 'viewDonHangPartner'])->name('viewDonHangPartnerr');
...
//yyyyy
Route::group(['middleware' => 'admin','partner', 'prefix' => '/admin/partner/'], function() {
    ...
    Route::group(['prefix' => '/don-hang'], function() {
        Route::get('/', [AdminController::class, 'viewDonHangAdmin'])->name('viewDonHangPartner');
        Route::post('/', [AdminController::class, 'dataDonHangAdmin'])->name('dataDonHangAdmin');
        Route::post('/doi-trang-thai', [AdminController::class, 'doiTrangThaiDonHangAdmin'])->name('doiTrangThaiDonHangAdmin');
        Route::post('/chi-tiet-don-hang', [AdminController::class, 'chiTietDonHangAdmin'])->name('chiTietDonHangAdmin');
        Route::post('/search', [AdminController::class, 'searchDonHang'])->name('searchDonHang');



        Route::get('/', [PartnerController::class, 'viewDonHangPartner'])->name('viewDonHangPartnerr');
        Route::post('/', [PartnerController::class, 'dataDonHangPartner'])->name('dataDonHangPartnerr');
        Route::post('/doi-trang-thai', [PartnerController::class, 'doiTrangThaiDonHangPartner'])->name('doiTrangThaiDonHangPartner');
        Route::post('/chi-tiet-don-hang', [PartnerController::class, 'chiTietDonHangPartner'])->name('chiTietDonHangPartner');
        Route::post('/search', [PartnerController::class, 'searchDonHang'])->name('searchDonHang');
    });
    ...
    // Route của Sản Phẩm
    Route::group(['prefix' => '/san-pham'], function() {
        Route::get('/', [SanPhamController::class, 'indexAdmin'])->name('viewSanPhamAdmin');
        Route::get('/data', [SanPhamController::class, 'getDataAdmin'])->name('dataSanPhamAdmin');
        Route::post('/status', [SanPhamController::class, 'statusAdmin'])->name('statusSanPhamAdmin');
        Route::post('/search', [SanPhamController::class, 'searchAdmin'])->name('searchSanPhamAdmin');
    });

    Route::group(['prefix' => '/profile'], function() {
        // Lấy thông tin của profile đang login
        Route::get('/', [AdminController::class, 'index_profile'])->name('viewProfilePartner');
        Route::post('/data', [AdminController::class, 'getProfile'])->name('getProfile');
        Route::post('/update', [AdminController::class, 'updateProfile'])->name('updateProfile');
...
Route::get('/partner', [AdminController::class, 'index_dashboards'])->name('viewDashboardsAdmin');
