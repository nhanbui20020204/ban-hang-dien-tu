    ...
    <div id="app_header">
                ...
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="/"><img
                                    class="main__logo--img " style="width: 150px; height: 100px"
                                    src="https://png.pngtree.com/png-clipart/20200710/original/pngtree-premium-vector-a-logo-in-gold-color-beautiful-logotype-design-png-image_4227612.jpg"
                                    alt="logo-img"></a>
                        </h1>
                    </div>
                    <div class="header__search--widget d-none d-lg-block header__sticky--none">
                        <form class="d-flex header__search--form border-radius-5" action="#">
                            ...
                            <div class="header__search--box">
                                <label>
                                    <input v-model="key_search" v-on:keyup.enter="timKiem()"
                                        class="header__search--input" placeholder="Search For Products..."
                                        type="text">
                                </label>
                                <button v-on:click="timKiem()" class="header__search--button bg__primary text-white"
                        ...
                        <nav class="header__menu--navigation">
                            <ul class="header__menu--wrapper d-flex">
                                <li class="header__menu--items">
                                    <a class="header__menu--link {{ Route::is('HomePageUser') ? 'active' : '' }}"
                                        href="/">Home Page </a>
                                </li>
                                {{-- <li class="header__menu--items">
                                ...
                                {{-- <li class="header__menu--items">
                                    <a class="header__menu--link {{ Route::is('showNews') ? 'active' : '' }}"
                                        href="{{ Route('showNews') }}">Tin Tức </a>
                                </li> --}}
                            </ul>
                        </nav>
                    </div>
                ...
                <div class="header__bottom--inner position__relative d-flex align-items-center">
                    ...
                    <div class="header__right--area d-flex justify-content-between align-items-center">
                        <div class="header__menu">
                            <nav class="header__menu--navigation ">
                                <ul class="header__menu--wrapper d-flex justify-content-center">
                                    <li class="header__menu--items" style="padding: 10px 0">
                                        <a class="header__menu--link text-white {{ Route::is('HomePageUser') ? 'active' : '' }}"
                                            href="/">Home Page </a>
                                    </li>
                                    {{-- <li class="header__menu--items">
                                    ...
                                    <li class="header__menu--items" style="padding: 10px 0">
                                        <a class="header__menu--link text-white {{ Route::is('allProduct') ? 'active' : '' }}"
                                            href="{{ Route('allProduct') }}">Danh sách Sản Phẩm </a>
                                    </li>
                                    {{-- <li class="header__menu--items" style="padding: 10px 0">
                                        <a class="header__menu--link text-white {{ Route::is('showNews') ? 'active' : '' }}"
                                            href="{{ Route('showNews') }}">Tin Tức </a>
                                    </li> --}}
                                </ul>
                            </nav>
        ...
        @if ($checklogin)
            <div class="offCanvas__minicart">
                            ...
                            <div class="minicart__text">
                                ...
                                <div class="minicart__text--footer d-flex align-items-center">
                                    <div class="quantity__box minicart__quantity">
                                        <button type="button" v-on:click="tru(v)" class="quantity__value decrease"
                                            aria-label="Giảm số lượng" value="Giảm giá trị">-</button>
                                        <label>
                                            <input v-model="v.so_luong" v-on:change="update(v)" type="number"
                                                class="quantity__number" data-counter />
                                        </label>
                                        <button type="button" v-on:click="cong(v)" class="quantity__value increase"
                                            aria-label="Tăng số lượng" value="Tăng giá trị">+</button>
                                    </div>
                ...
                <a href="http://127.0.0.1:8000/all-product"><i class="fa-solid fa-plus">
