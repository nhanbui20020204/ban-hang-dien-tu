                            ...
                            <form>
                                ...
                                <div class="product__details--info__price mb-12">
                                    ...
                                    @else
                                        <span
                                            ...
                                            đ</span>
                                        <span class="old__price"><s>{{ number_format($sanPham->gia_ban, 0, ',', '.') }}
                                                đ</s></span>
                                    @endif
                                </div>
                                ...
                                <div class="product__variant">
                                    <div class="product__variant--list quantity d-flex align-items-center mb-20">
                                        ...
                                        <span style="margin-left: 10px;">{{ $sanPham->so_luong_nhap }} sản phẩm có
                                            sẵn</span>
                                    </div>
                                    <div class="product__variant--list mb-15">
                                        ...
                                        <div>
                                            @if (Auth::guard('user')->check())
                                                <a class="yeuThich variant__wishlist--icon mb-15"
                                                    data-id="{{ $sanPham->id }}" title="Add to wishlist">
                                                    @php
                                                    ...
                                                    <div id="icon_yeu_thich">
                                                        @if ($check)
                                                            <i
                                                                class="quickview__variant--wishlist__svg fa-solid fa-heart text-danger"></i>
                                                        @else
                                        ...
                                        <div>
                                            @if (Auth::guard('user')->check())
                                                <button v-on:click="themGioHang()"
                                                    class="primary__btn quickview__cart--btn" type="button"
                                                    style="margin-left: 0!important; background-color: #fbebed!important; color: red!important;">
                                                    <i class="fa-solid fa-cart-plus" style="color: red!important;"></i>
                                                    Add To Cart</button>
                                            @else
                                            ...
                                            @endif
                                            <button class="primary__btn quickview__cart--btn" type="submit">Buy it
                                                now</button>
                                        </div>
                                    </div>
                                </div>
