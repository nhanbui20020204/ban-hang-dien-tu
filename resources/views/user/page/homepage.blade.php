        ...
        <section class="product__section section--padding  pt-0" style="margin-top: 20px">
            <div class="container">
                ...
                <div class="product__section--inner">
                    <div class="row row-md-reverse container">
                        <div class="col-12">
                            <div class="sidebar__category">
                                <style>
                                    .choose__category--menu {
                                ...
                                <div class="choose__category--content">
                                    <h2 class="choose__category--title">Chuyên mục</h2>
                                    <ul class="choose__category--menu row  justify-content-center">
                                        @foreach ($chuyenMuc as $key => $value)
                                            <li class="choose__category--menu__list col-3">
                                                ...
                                                <a class="choose__category--menu__link row justify-content-center align-items-center" 
                                                    href="/product/{{ $value->id }}">
                                                    <img src={{ $value->hinh_anh }} alt="" style="width: 150px; height: 100px;" />
                                                    <span style="text-align: center">{{$value->ten_chuyen_muc}}</span>
                                                </a>
                                            </li>
                                        @endforeach
                                    </ul>
                                ...
                                <div id="recent" class="tab-pane fade show active" role="tabpanel">
                                    <div class="product__wrapper">
                                        <div class="row mb--n30">
                                            @foreach ($sanPham as $key => $value)
                                                <div
                                                    class="col-lg-4 col-md-4 col-sm-6 col-6 custom-col mb-30 d-flex align-items-stretch">
                                                ...
                                                <article class="product__card">
                                                    ...
                                                    <div class="product__card--content">
                                                        ...
                                                        <h3 class="product__card--title">
                                                            <a href="product-details.html">Sequi eum saepe nisi repellat
                                                                at fuga nemo. </a>
                                                        </h3>
                                                        <div class="product__card--price">
                                                            <span class="current__price">$222.52</span>
