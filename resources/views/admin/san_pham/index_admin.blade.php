        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    Danh Sách Sản Phẩm
                <a href="http://127.0.0.1:8000/partner/login" ><i class="fa-solid fa-plus">
        ...
        new Vue({
            ...
            methods: {
                ...
                timKiem() {
                    ...
                    axios
                        .post('{{ Route('searchSanPhamAdmin') }}', payload)
                        .then((res) => {
