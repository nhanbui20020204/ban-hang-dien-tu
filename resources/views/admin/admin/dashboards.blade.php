...
<div class="row match-height">
    ...
    <div class="col-xl-4 col-md-6 col-12">
        <div class="card card-congratulation-medal">
            <div class="card-body">
                <h5>Doanh thu 🎉</h5>
                <p class="card-text font-small-3">Tổng doanh thu hiện có!!</p>
                <h3 class="mb-75 mt-2 pt-50">
                    <a href="#">$48.9k</a>
                </h3>
                <button type="button" class="btn btn-primary waves-effect waves-float waves-light">Xem doanh thu</button>
                <img src="/assets_admin/app-assets/images/illustration/badge.svg" class="congratulation-medal" alt="Medal Pic">
            </div>
        </div>
    </div>
    <!--/ Medal Card -->
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-sm-6 col-12">
                        <div class="d-flex flex-row">
                            ...
                            <div class="my-auto">
                                <h4 class="fw-bolder mb-0">$48.9k</h4>
