<nav class="header-navbar navbar-expand-lg navbar navbar-fixed align-items-center navbar-shadow navbar-brand-center"
    ...
    <div class="navbar-header d-xl-block d-none">
        <ul class="nav navbar-nav">
            <li class="nav-item"><a class="navbar-brand" href="{{ Route("viewDashboardsAdmin") }}"><span
                        class="brand-logo">
                ...
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                    ...
                    <li class="scrollable-container media-list">
                        <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                src="/assets_admin/images/pages/eCommerce/1.png" alt="donuts" width="62">
                        ...
                        <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                src="/assets_admin/images/pages/eCommerce/7.png" alt="donuts" width="62">
                            <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove"
                                    data-feather="x"></i>
                                <div class="media-heading">
                                    <h6 class="cart-item-title"><a class="text-body"
                        ...
                        <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                src="/assets_admin/images/pages/eCommerce/2.png" alt="donuts" width="62">
                            <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove"
                                    data-feather="x"></i>
                                <div class="media-heading">
                                    <h6 class="cart-item-title"><a class="text-body"
                        ...
                        <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                src="/assets_admin/images/pages/eCommerce/3.png" alt="donuts" width="62">
                            <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove"
                                    data-feather="x"></i>
                                <div class="media-heading">
                                    <h6 class="cart-item-title"><a class="text-body"
                        ...
                        <div class="list-item align-items-center"><img class="d-block rounded me-1"
                                src="/assets_admin/images/pages/eCommerce/5.png" alt="donuts" width="62">
                            <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove"
                                    data-feather="x"></i>
                                <div class="media-heading">
                                    <h6 class="cart-item-title"><a class="text-body"
                ...
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                    ...
                    <li class="scrollable-container media-list"><a class="d-flex" href="#">
                            <div class="list-item d-flex align-items-start">
                                <div class="me-1">
                                    <div class="avatar"><img src="/assets_admin/images/portrait/small/avatar-s-15.jpg"
                            ...
                            <div class="list-item d-flex align-items-start">
                                <div class="me-1">
                                    <div class="avatar"><img src="/assets_admin/images/portrait/small/avatar-s-3.jpg"
                                            alt="avatar" width="32" height="32"></div>
                                </div>
                                <div class="list-item-body flex-grow-1">
            ...
            <li class="nav-item dropdown dropdown-user">
                ...
                @if ($partner)
                    ...
                    <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">
                        {{ $partner->ho_lot }} {{ $partner->ten }}
                    </span><span class="user-status">Partner</span></div><span class="avatar"><img
                            class="round" src="/assets_admin//images/portrait/small/avatar-s-11.jpg" alt="avatar"
                            height="40" width="40"><span class="avatar-status-online"></span></span>
                    </a>

                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                        <a class="dropdown-item" href="{{ Route("viewProfilePartner") }}"><i class="me-50" data-feather="user"> </i>
                            Profile</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ Route("partnerLogOut") }}"><i class="me-50"data-feather="power"></i>
                            Logout</a>
                    </div>
                @else
                    <a class="nav-link dropdown-toggle dropdown-user-link"
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                        <a class="dropdown-item" href="/admin/profile"><i class="me-50" data-feather="user"> </i>
                            Profile</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ Route("adminLogOut") }}"><i class="me-50"data-feather="power"></i>
                            Logout</a>
                    </div>
                @endif
            </li>
...
{{-- <ul class="main-search-list-defaultlist d-none">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
            ...
            <div class="d-flex">
                <div class="me-75"><img src="/assets_admin/images/icons/xls.png" alt="png" height="32">
                </div>
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
            href="app-file-manager.html">
            <div class="d-flex">
                <div class="me-75"><img src="/assets_admin/images/icons/jpg.png" alt="png" height="32">
                </div>
                <div class="search-data">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
            href="app-file-manager.html">
            <div class="d-flex">
                <div class="me-75"><img src="/assets_admin/images/icons/pdf.png" alt="png" height="32">
                </div>
                <div class="search-data">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100"
            href="app-file-manager.html">
            <div class="d-flex">
                <div class="me-75"><img src="/assets_admin/images/icons/doc.png" alt="png" height="32">
                </div>
                <div class="search-data">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
            ...
            <div class="d-flex align-items-center">
                <div class="avatar me-75"><img src="/assets_admin/images/portrait/small/avatar-s-8.jpg"
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
            href="app-user-view-account.html">
            <div class="d-flex align-items-center">
                <div class="avatar me-75"><img src="/assets_admin/images/portrait/small/avatar-s-1.jpg"
                        alt="png" height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
            href="app-user-view-account.html">
            <div class="d-flex align-items-center">
                <div class="avatar me-75"><img src="/assets_admin/images/portrait/small/avatar-s-14.jpg"
                        alt="png" height="32"></div>
                <div class="search-data">
    ...
    <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100"
            href="app-user-view-account.html">
            <div class="d-flex align-items-center">
                <div class="avatar me-75"><img src="/assets_admin/images/portrait/small/avatar-s-6.jpg"
                        alt="png" height="32"></div>
                <div class="search-data">
