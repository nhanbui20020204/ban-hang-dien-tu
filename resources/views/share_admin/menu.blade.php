        ...
        <div class="navbar-container main-menu-content" data-menu="menu-container">
            ...
            <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                @if (Auth::guard('admin')->check() == true)
                    ...
                    <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                        href="{{ Route('viewDonHangPartnerr') }}" data-bs-toggle="" data-i18n="Profile"><i class="fa-solid fa-landmark"></i><span data-i18n="Profile">Đơn Hàng</span></a>
                </li>
                    <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                    ...
                    <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                            href="{{ Route('viewSanPhamAdmin') }}" data-bs-toggle="" data-i18n="Profile"><i
                    ...
                    <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                            href="{{ Route('viewCustomer') }}" data-bs-toggle="" data-i18n="Profile"><i
                                class="fa-solid fa-users"></i><span data-i18n="Profile">Người dùng</span></a>
                    </li>
                    <li class="dropdown nav-item" data-menu="dropdown"><a
                        ...
                        <ul class="dropdown-menu" data-bs-popper="none">
                            ...
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                                    href="{{ Route('viewThongKe2') }}" data-bs-toggle=""
                                    data-i18n="Raise Support"><span data-i18n="Raise Support">Số Tiền Mỗi Mặt Hàng Bán
                                        Được</span></a>
                            </li>
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                                    href="{{ Route('viewThongKe3') }}" data-bs-toggle=""
                                    data-i18n="Raise Support"><span data-i18n="Raise Support">Số Lượng Mỗi Mặt Hàng
                                        Bán Được</span></a>
                            </li>
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                                    href="{{ Route('viewThongKe4') }}" data-bs-toggle=""
                                    data-i18n="Raise Support"><span data-i18n="Raise Support">Số Tiền Các Đại Lý Bán
                                        Được</span></a>
                            </li>
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                        ...
                        <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                            href="{{ Route('viewDanhGiaAdmin') }}" data-bs-toggle="" data-i18n="Profile"><i
                                class="fa-regular fa-star"></i><span data-i18n="Profile">Đánh Giá</span></a>
                    </li>
                    </li>
                ...
                @elseif (Auth::guard('partner')->check() == true)
                    ...
                    <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                        href="{{ Route('viewDonHangPartnerr') }}" data-bs-toggle="" data-i18n="Profile"><i
                            data-feather="user"></i><span data-i18n="Profile">Đon Hang</span></a>
                </li>
                    <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                    ...
                    <li class="dropdown nav-item" data-menu="dropdown"><a
                        ...
                        <ul class="dropdown-menu" data-bs-popper="none">
                            ...
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center"
                                    ...
                                    data-i18n="Documentation"><span data-i18n="Documentation">Số Tiền Thu Được Trong
                                        Một
                                        Ngày</span></a>
                            </li>
                            <li data-menu=""><a class="dropdown-item d-flex align-items-center"
